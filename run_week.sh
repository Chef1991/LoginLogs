...
lastRun=`$date --date="1 week ago" +"%F %T"`
runDay=`$date --date="1 week ago" +"%F"`
...
$csvParser -d $runDay -o $_reports/login_$runDay_week.html

sleep 10
mkdir $_export/login_week_$runDay
mv $_reports/* $_export/login_week_$runDay
